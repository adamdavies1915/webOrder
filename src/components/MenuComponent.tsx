...
import { IonContent, IonList, IonItem, IonCard, IonCardHeader, IonCardTitle, IonCardSubtitle, IonCardContent, IonButton, IonIcon, IonListHeader, IonAvatar, IonLabel } from '@ionic/react';
...
const MenuComponent: React.FC = () => {
    ...
    return (
      <IonContent>
        {state.map(category => 
          <IonList>
          <IonListHeader>{category.title}</IonListHeader>
